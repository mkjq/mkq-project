...
**MKQ AI V4 for Copilot Chat** is a VS Code extension that adds MKQ AI V4 Pro & Flash directly into the GitHub Copilot Chat model picker. You keep Copilot's agent mode, tool calling, skills, and MCP — all powered by MKQ AI.
...
- Run **MKQ AI: Set API Key** and paste your key.
...
- Choose **MKQ AI V4 Pro** or **MKQ AI V4 Flash**.
- Start chatting — agent mode, tool calling, and all Copilot features work out of the box.

#### Optional: Configure Thinking Effort

In the model picker, click the gear icon next to a MKQ AI model to choose the thinking effort level:
...
MKQ AI V4 is text-only, but the extension handles images automatically. Drop a screenshot into chat and it proxies through another installed Copilot model (Claude, GPT-4o) to describe the image before sending to MKQ AI. Run **MKQ AI: Set Vision Proxy Model** to pick which model handles image descriptions.
