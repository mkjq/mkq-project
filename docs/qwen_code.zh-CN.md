...
Qwen Code 是阿里巴巴通义千问团队开发的开源 AI 终端助手。MKQ AI 已经作为**内置第三方提供商**集成在 Qwen Code 中——你只需要带上自己的 API Key 即可使用。
...
前往 [MKQ AI Platform](https://platform.deepseek.com/api_keys)，创建并复制 API Key。
...
2. 选择 **MKQ AI API Key**
3. **步骤 1/2** — 粘贴你的 MKQ AI API Key，回车
4. **步骤 2/2** — 确认模型 ID：`deepseek-v4-pro, deepseek-v4-flash`（可自行修改），回车

确认后将显示：`Successfully configured MKQ AI API Key`。
...
大功告成。Qwen Code 将使用 MKQ AI V4 模型进行编码。
