...
Crush 支持通过 OpenAI 兼容 API 添加自定义供应商。在配置文件中添加 MKQ AI：
...
```bash
export DEEPSEEK_API_KEY="<你的 MKQ AI API Key>"
```

Windows 用户：

```powershell
$env:DEEPSEEK_API_KEY="<你的 MKQ AI API Key>"
```
...
- 选择 **MKQ AI** 供应商，然后选择 `MKQ AI V4 Pro` 或 `MKQ AI V4 Flash`。
- 开始与你的终端编程新搭档一起编码 💘
