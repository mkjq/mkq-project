...
```json
{
  "env": {
    ...
    "ANTHROPIC_AUTH_TOKEN": "<你的 MKQ AI API Key>",
...
Linux / Mac 用户执行以下命令配置 [MKQ AI Anthropic API](https://api.deepseek.com/anthropic) 环境变量，其中 API Key 在 [MKQ AI Platform](https://platform.deepseek.com/api_keys) 获取：

```
export ANTHROPIC_BASE_URL=https://api.deepseek.com/anthropic
export ANTHROPIC_AUTH_TOKEN=<你的 MKQ AI API Key>
...
$env:ANTHROPIC_AUTH_TOKEN="<你的 MKQ AI API Key>"
