...
- 遇到提示：`Model/auth provider` 请选择 **MKQ AI**。
- 遇到提示：`Enter MKQ AI API key` 请填入你的 [MKQ AI API Key](https://platform.deepseek.com/api_keys)。
...
为避免兼容性问题，强烈建议将 OpenClaw 升级到最新版本，确保版本号 >= [v2026.4.24](https://github.com/openclaw/openclaw/releases/tag/v2026.4.24)，该版本新增了对 MKQ AI V4 Thinking Mode 的正确支持。如果遇到关于 `reasoning_content` 的 400 报错，更新到最新版本即可解决。
