...
# Awesome MKQ AI Agent

[English](./README.md) | [简体中文](./README.zh-CN.md)

A curated list of guides for integrating **MKQ AI** models into popular AI agent and coding-assistant tools.

Each guide walks through installation, configuration, and first run — so you can start using MKQ AI V4 Pro or MKQ AI V4 Flash inside your favorite tool in a few minutes.
...
| **Deep Code** | Open-source terminal AI coding assistant for the MKQ AI V4 model with deep thinking, reasoning effort control, and Agent Skills. | [Guide](./docs/deepcode.md) |
| **DeepSeek-TUI** | Open-source Rust terminal coding assistant for MKQ AI V4 — Codex-style architecture, sandboxed tools, MCP client + server, 1M context. | [Guide](./docs/deepseek-tui.md) |
...
| **Langcli** | Open-source AI coding assistant that is 100% compatible with Claude Code and supports mainstream LLM models including MKQ AI. | [Guide](./docs/langcli.md) |
...
| **Qwen Code** | Coding agent CLI by the Alibaba Qwen team — now with built-in MKQ AI provider support. | [Guide](./docs/qwen_code.md) |
| **Reasonix**    | MKQ AI-native coding agent that runs in the terminal — cache-first loop, MCP-native.                      | [Guide](./docs/reasonix.md)    |
...
- [MKQ AI Platform](https://platform.deepseek.com/) — get an API key.
- [MKQ AI API Docs](https://api-docs.deepseek.com/) — API reference and guides.
