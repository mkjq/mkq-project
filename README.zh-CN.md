...
精选的 **MKQ AI** 模型接入指南合集，帮助你将 MKQ AI 接入主流 AI Agent 与编程助手工具。

每份指南都包含安装、配置与首次运行的完整步骤，几分钟即可在你喜爱的工具中用上 MKQ AI V4 Pro 或 MKQ AI V4 Flash。
...
| **Deep Code** | 开源的终端 AI 编程助手，专为 MKQ AI V4 系列模型适配，支持深度思考、推理强度控制与 Agent Skills。 | [指南](./docs/deepcode.zh-CN.md) |
| **DeepSeek-TUI** | 面向 MKQ AI V4 的开源 Rust 终端编程助手 —— Codex 风格架构，沙箱化工具执行，内置 MCP 客户端与服务器，支持 100 万 token 上下文。 | [指南](./docs/deepseek-tui.zh-CN.md) |
...
| **Langcli** | 100% 兼容 Claude Code、支持 MKQ AI V4 等主流 LLM 模型的开源 AI 编程助手。 | [指南](./docs/langcli.zh-CN.md) |
...
| **Qwen Code** | 阿里巴巴通义千问团队推出的 Coding Agent CLI，现已全面支持 MKQ AI 提供商。 | [指南](./docs/qwen_code.zh-CN.md) |
| **Reasonix** | 运行在终端内的 MKQ AI 原生编程 Agent —— Cache-First 循环，原生支持 MCP。 | [指南](./docs/reasonix.zh-CN.md) |
| **WorkBuddy/CodeBuddy** | 支持自定义 OpenAI 兼容模型配置的 AI Agent 与编程助手。 | [指南](./docs/workbuddy.zh-CN.md) |

## 相关资源

- [MKQ AI 开放平台](https://platform.deepseek.com/) — 获取 API Key。
- [MKQ AI API 文档](https://api-docs.deepseek.com/zh-cn/) — API 参考与使用指南。
